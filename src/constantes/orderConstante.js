...
export const ORDER_HISTORIC_REQUEST = 'ORDER_HISTORY_REQUEST'
export const ORDER_HISTORIC_SUCCESS = 'ORDER_HISTORY_SUCCESS'
export const ORDER_HISTORIC_ERROR = 'ORDER_HISTORY_ERROR'
